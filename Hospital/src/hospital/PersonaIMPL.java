...
public class PersonaIMPL implements Cloneable, Comparable <Persona>, Persona, Serializable{
	...
	//De copia
	public PersonaIMPL(PersonaIMPL persona)
	{
	...
	//Ordinario
	public PersonaIMPL (String nombre, String apellidos, int edad, String dni, char sexo, String telefono, Domicilio domicilio) throws HospitalException 
	{
